...
describe("the static preview build", () => {
  ...
  test("has everything the page loads, and nothing it doesn't", () => {
    for (const file of ["styles.css", "favicon.svg", "js/main.js", "js/email.js", "fonts/eb-garamond.woff2", "media/trailer-720.mp4", "media/trailer-720.webm", "media/trailer-1080.mp4", "media/trailer-calm-720.mp4", "media/still-deck.jpg", "media/poster.jpg", "media/social-card.jpg", "media/photos/ship.jpg", "media/photos/cecil-portrait.jpg", "media/photos/kingsley.jpg"]) {
  ...
  test("fingerprints every media address, so a changed video is never replaced by a saved copy", () => {
    ...
    assert.match(html, /poster="\/media\/still-deck\.jpg\?v=[0-9a-f]{10}"/);
